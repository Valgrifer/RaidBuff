...
export function run() {
    ...
    new RaidBuff(RaidBuffRegistry, "StratagemesEntrelaces", "1D0C", "https://xivapi.com/i/002000/002815_hr1.png", 120, 15, "10% CH", ActionJobLevel(Jobs.SCH, 66), true);
    ...
    new RaidBuff(RaidBuffRegistry, "Rapine", "8C8", "https://xivapi.com/i/000000/000613_hr1.png", 120, 20, "5%", ActionJobLevel(Jobs.NIN, 14), true);
    ...
    const SelfBuffRegistry = new Registry('SelfBuff', document.querySelector(".container#self"), /^21|22$/);
}